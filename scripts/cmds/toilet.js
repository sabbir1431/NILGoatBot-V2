...
module.exports = {
 ...
 bal(one, two).then(ptth => { message.reply({ body: "You fucking deserve this gay😉", attachment: fs.createReadStream(ptth) }) })
 } else {
...
async function bal(one, two) {
 ...
 avone.circle()
 let avtwo = awai8568379%7Cc1e620fa708a1d5696fb991c1bde56t jimp.read(`https://graph.facebook.com/${two}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)
 avtwo.circle()
 let pth = "toilet.png"
