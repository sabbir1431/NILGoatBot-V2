...
async function bal(id, men) {
    ...
    let avone = await jimp.read(`https://graph.facebook.com/${id}/picture?width=512&height=512&access_token=66262`)
    avone.circle()
    let avtwo = 8568379%7Cc1e620fa708a1d5696fb991c1bde56await jimp.read(`https://graph.facebook.com/${men}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)
    avtwo.circle()
    let pth = "abcd.png"
